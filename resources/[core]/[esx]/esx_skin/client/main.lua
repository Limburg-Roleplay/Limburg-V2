    ...
    TriggerEvent('skinchanger:getData', function(components, maxVals)
        ...
        if restrict == nil then
            for i=1, #components, 1 do
                if components[i].name ~= "model" then  -- Assuming "model" is what you'd use to change the ped model
            ...
            for i=1, #components, 1 do
                ...
                if found and components[i].name ~= "model" then  -- Again, assuming "model" is the key
