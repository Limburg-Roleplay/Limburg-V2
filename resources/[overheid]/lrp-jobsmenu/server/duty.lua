...
RegisterServerEvent('lrp-jobsmenu:server:toggleDuty')
AddEventHandler('lrp-jobsmenu:server:toggleDuty', function(job)
    ...
    if (job == 'police' or job == 'ambulance' or job == 'mechanic')  or job == 'kmar' or job == 'pitstop' or job == 'advocaat' then
        ...
        TriggerClientEvent("lrp-notifications:client:notify", _source, 'info', 'Je bent uitgeklokt als '.. xPlayer.job.label ..'')
	--exports['lrp-logger']:createLog(webhook, 'Speler Uitgeklokt', '**Speler:** '..GetPlayerName(_source)..'\n**Baan:** '..xPlayer.job.label..'\n**Rang:** '..xPlayer.job.grade_label, false, 'Duty') 
    ...
    elseif (job == 'offpolice') then
        ...
        TriggerClientEvent("lrp-notifications:client:notify", _source, 'success', 'Je bent ingeklokt als '.. xPlayer.job.label ..'')
	--exports['lrp-logger']:createLog(webhook, 'Speler Ingeklokt', '**Speler:** '..GetPlayerName(_source)..'\n**Baan:** '..xPlayer.job.label..'\n**Rang:** '..xPlayer.job.grade_label, false, 'Duty') 
