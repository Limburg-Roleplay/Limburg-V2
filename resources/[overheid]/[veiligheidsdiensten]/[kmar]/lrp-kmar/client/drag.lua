...
RegisterNetEvent('jtm-development:kmar:client:player:handler:vehicle')
AddEventHandler('jtm-development:kmar:client:player:handler:vehicle', function()
...
RegisterNetEvent('jtm-development:kmar:client:startDragging')
AddEventHandler('jtm-development:kmar:client:startDragging', function(copId)
	dragStatus['isDragged'] = not dragStatus['isDragged']
	dragStatus['copId'] = tonumber(copId)
end)

RegisterNetEvent('jtm-development:kmar:client:dragging')
AddEventHandler('jtm-development:kmar:client:dragging', function(data)
    local entity = data.entity
    local entityPlayer = ESX.Game.GetPlayerFromPed(entity)
    ...
    TriggerServerEvent('jtm-development:kmar:server:onDrag', GetPlayerServerId(entityPlayer))
...
RegisterNetEvent('jtm-development:kmar:client:syncz:drag')
AddEventHandler('jtm-development:kmar:client:syncz:drag', function()
	setIsDragged(true)
	dragStatus['isDragged'] = true
end)

RegisterNetEvent('jtm-development:kmar:client:syncs:drag')
AddEventHandler('jtm-development:kmar:client:syncs:drag', function()
	setIsDragged(false)
