...
RegisterNetEvent('jtm-development:police:client:player:handler:vehicle')
AddEventHandler('jtm-development:police:client:player:handler:vehicle', function()
...
RegisterNetEvent('jtm-development:police:client:startDragging')
AddEventHandler('jtm-development:police:client:startDragging', function(copId)
	dragStatus['isDragged'] = not dragStatus['isDragged']
	dragStatus['copId'] = tonumber(copId)
end)

RegisterNetEvent('jtm-development:police:client:dragging')
AddEventHandler('jtm-development:police:client:dragging', function(data)
    local entity = data.entity
    local entityPlayer = ESX.Game.GetPlayerFromPed(entity)
    ...
    TriggerServerEvent('jtm-development:police:server:onDrag', GetPlayerServerId(entityPlayer))
...
RegisterNetEvent('jtm-development:police:client:syncz:drag')
AddEventHandler('jtm-development:police:client:syncz:drag', function()
	setIsDragged(true)
	dragStatus['isDragged'] = true
end)

RegisterNetEvent('jtm-development:police:client:syncs:drag')
AddEventHandler('jtm-development:police:client:syncs:drag', function()
	setIsDragged(false)
