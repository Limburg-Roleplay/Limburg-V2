...
RegisterNetEvent("frp-dsischild:toggle")
AddEventHandler("frp-dsischild:toggle", function()
    if (PlayerData.job ~= nil and (PlayerData.job.name == 'kmar') or (PlayerData.job.name == 'police')) then
