...
RegisterServerEvent('lrp-anwb:server:repair:vehicle')
AddEventHandler('lrp-anwb:server:repair:vehicle', function(id)
...
RegisterServerEvent('lrp-anwb:server:wash:vehicle')
AddEventHandler('lrp-anwb:server:wash:vehicle', function()
    local xPlayer = ESX.GetPlayerFromId(source)
...
RegisterServerEvent("lrp-anwb:promotemember")
AddEventHandler(
    "lrp-anwb:promotemember",
...
RegisterServerEvent("lrp-anwb:demote")
AddEventHandler(
    "lrp-anwb:demote",
    function(identifierplayer, voornaamplayer)
        local src = source
...
RegisterServerEvent("lrp-anwb:deletemember:serversided")
AddEventHandler(
    "lrp-anwb:deletemember:serversided",
    function(identifierplayer, voornaamplayer)
        local src = source
        local xPlayer = ESX.GetPlayerFromId(src)
        local playerHex = string.gsub(tostring(GetPlayerIdentifier(src)), "license:", "")
