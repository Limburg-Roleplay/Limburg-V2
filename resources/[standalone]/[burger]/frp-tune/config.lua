...
Config.Zones = {
	...
	ls1 = {
		Pos   = { x = 107.59, y = 6624.31, z = 31.78},
		Size  = {x = 4.0, y = 4.0, z = 0.2},
	...
	ls7 = {
		Pos   = { x = -863.7470, y =-1458.4425, z = 0},
		Size  = {x = 8.0, y = 8.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
		Hint  = _U('press_custom')
	...
	ls8 = {
		Pos   = { x = -344.0538, y = -142.3230, z = 60.6088},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
	...
	ls9 = {
		Pos   = { x = 4520.8945, y = -4469.8193, z = 4.1835},
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
	...
	ls10 = {
		Pos   = { x = -1273.7072, y = -3384.3198, z = 13.9401},
...
function GetColors(color)
	...
	elseif color == 'flips' then
		colors = {
			{ index = 161, label = _U('ANOD_RED')},
			{ index = 162, label = _U('ANOD_WINE')},
			{ index = 163, label = _U('ANOD_PURPLE')},
			{ index = 164, label = _U('ANOD_BLUE')},
			{ index = 165, label = _U('ANOD_GREEN')},
			{ index = 166, label = _U('ANOD_LIME')},
			{ index = 167, label = _U('ANOD_COPPER')},
			{ index = 168, label = _U('ANOD_BRONZE')},
			{ index = 169, label = _U('ANOD_CHAMPAGNE')},
			{ index = 170, label = _U('ANOD_GOLD')},
			{ index = 171, label = _U('GREEN_BLUE_FLIP')},
			{ index = 172, label = _U('GREEN_RED_FLIP')},
			{ index = 173, label = _U('GREEN_BROW_FLIP')},
			{ index = 174, label = _U('GREEN_TURQ_FLIP')},
			{ index = 175, label = _U('GREEN_PURP_FLIP')},
			{ index = 176, label = _U('TEAL_PURP_FLIP')},
			{ index = 177, label = _U('TURQ_RED_FLIP')},
			{ index = 178, label = _U('TURQ_PURP_FLIP')},
			{ index = 179, label = _U('CYAN_PURP_FLIP')},
			{ index = 180, label = _U('BLUE_PINK_FLIP')},
			{ index = 181, label = _U('BLUE_GREEN_FLIP')},
			{ index = 182, label = _U('PURP_RED_FLIP')},
			{ index = 183, label = _U('PURP_GREEN_FLIP')},
			{ index = 184, label = _U('MAGEN_GREE_FLIP')},
			{ index = 185, label = _U('MAGEN_YELL_FLIP')},
			{ index = 186, label = _U('BURG_GREEN_FLIP')},
			{ index = 187, label = _U('MAGEN_CYAN_FLIP')},
			{ index = 188, label = _U('COPPE_PURP_FLIP')},
			{ index = 189, label = _U('MAGEN_ORAN_FLIP')},
			{ index = 190, label = _U('RED_ORANGE_FLIP')},
			{ index = 191, label = _U('ORANG_PURP_FLIP')},
			{ index = 192, label = _U('ORANG_BLUE_FLIP')},
			{ index = 193, label = _U('WHITE_PURP_FLIP')},
			{ index = 194, label = _U('RED_RAINBO_FLIP')},
			{ index = 195, label = _U('BLU_RAINBO_FLIP')},
			{ index = 196, label = _U('DARKGREENPEARL')},
			{ index = 197, label = _U('DARKTEALPEARL')},
			{ index = 198, label = _U('DARKBLUEPEARL')},
			{ index = 199, label = _U('DARKPURPLEPEARL')},
			{ index = 200, label = _U('OIL_SLICK_PEARL')},
			{ index = 201, label = _U('LIT_GREEN_PEARL')},
			{ index = 202, label = _U('LIT_BLUE_PEARL')},
			{ index = 203, label = _U('LIT_PURP_PEARL')},
			{ index = 204, label = _U('LIT_PINK_PEARL')},
			{ index = 205, label = _U('OFFWHITE_PRISMA')},
			{ index = 206, label = _U('PINK_PEARL')},
			{ index = 207, label = _U('YELLOW_PEARL')},
			{ index = 208, label = _U('GREEN_PEARL')},
			{ index = 209, label = _U('BLUE_PEARL')},
			{ index = 210, label = _U('CREAM_PEARL')},
			{ index = 211, label = _U('WHITE_PRISMA')},
			{ index = 212, label = _U('GRAPHITE_PRISMA')},
			{ index = 213, label = _U('DARKBLUEPRISMA')},
			{ index = 214, label = _U('DARKPURPPRISMA')},
			{ index = 215, label = _U('HOT_PINK_PRISMA')},
			{ index = 216, label = _U('RED_PRISMA')},
			{ index = 217, label = _U('GREEN_PRISMA')},
			{ index = 218, label = _U('BLACK_PRISMA')},
			{ index = 219, label = _U('OIL_SLIC_PRISMA')},
			{ index = 220, label = _U('RAINBOW_PRISMA')},
			{ index = 221, label = _U('BLACK_HOLO')},
			{ index = 222, label = _U('WHITE_HOLO')},
			{ index = 223, label = _U('YKTA_MONOCHROME')},
			{ index = 224, label = _U('YKTA_NITE_DAY')},
			{ index = 225, label = _U('YKTA_VERLIERER2')},
			{ index = 226, label = _U('YKTA_SPRUNK_EX')},
			{ index = 227, label = _U('YKTA_VICE_CITY')},
			{ index = 228, label = _U('YKTA_SYNTHWAVE')},
			{ index = 229, label = _U('YKTA_FOUR_SEASO')},
			{ index = 230, label = _U('YKTA_M9_THROWBA')},
			{ index = 231, label = _U('YKTA_BUBBLEGUM')},
			{ index = 232, label = _U('YKTA_FULL_RBOW')},
			{ index = 233, label = _U('YKTA_SUNSETS')},
			{ index = 234, label = _U('YKTA_THE_SEVEN')},
			{ index = 235, label = _U('YKTA_KAMENRIDER')},
			{ index = 236, label = _U('YKTA_CHROMABERA')},
			{ index = 237, label = _U('YKTA_CHRISTMAS')},
			{ index = 238, label = _U('YKTA_TEMPERATUR')},
			{ index = 239, label = _U('YKTA_HSW')},
			{ index = 240, label = _U('YKTA_ELECTRO')},
			{ index = 241, label = _U('YKTA_MONIKA')},
			{ index = 242, label = _U('YKTA_FUBUKI')}
		}
	end
	return colors
end
