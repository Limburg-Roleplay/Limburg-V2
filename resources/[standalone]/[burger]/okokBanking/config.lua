...
Config.UseTargetOnAtm = true -- Using ox_target or q-target and not TextUI to access to the atms
...
Config.IBANPrefix = "LRP" -- IBAN prefix
...
Config.BotName = 'Limburg' -- Write the desired bot name

Config.ServerName = 'Limburg' -- Write your server's name
