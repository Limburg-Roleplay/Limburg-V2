...
RegisterNetEvent('lrp-luchtvaartdealer:client:handler:startFotobook')
AddEventHandler('lrp-luchtvaartdealer:client:handler:startFotobook', function(group)
                ...
                ESX.Game.SpawnVehicle(vehName, Shared.Fotobook.CarSettings['coords'], Shared.Fotobook.CarSettings['heading'], function(veh) 
                    ...
                    for cameraId = 1, #Shared.Fotobook.Cameras do
                        ...
                        for k,v in pairs(Shared.Fotobook.Colors) do
                            ...
                            TriggerServerEvent('lrp-luchtvaartdealer:server:handler:requestscreenshot', vehName, cameraId, vehBrand, k)
                            Wait(375)
                        end
