...
CreateThread(function()
    ...
    ESX.TriggerServerCallback('lrp-luchtvaartdealer:server:cb:get:shared', function(data)
        Shared = data
    end)
...
RegisterNetEvent('lrp-luchtvaartdealer:client:open:catalogus')
AddEventHandler('lrp-luchtvaartdealer:client:open:catalogus', function()
    local vehicles = {}
...
RegisterNUICallback('buyVehicle', function(data, cb)
    ...
    ESX.TriggerServerCallback('lrp-luchtvaartdealer:server:cb:buyVehicle', function(buyCallback, plateText)
        ...
        for i=1, #Shared.HeliSpawnPlaces do
            ...
            ESX.Game.SpawnVehicle(vehicle.model, Shared.HeliSpawnPlaces[spawnPlace].coords, Shared.HeliSpawnPlaces[spawnPlace].heading, function(veh)
                ...
                ESX.TriggerServerCallback('lrp-luchtvaartdealer:server:saveVehicle', function(isDone)
...
Exios.Functions.ConfirmQuickSellMenu = function(vehicle, vehLabel, sellPrice)
    ...
    lib.registerContext({
        id = 'lrp-luchtvaartdealer:client:confirm:quickSell',
    ...
    lib.showContext('lrp-luchtvaartdealer:client:confirm:quickSell')
end
    ...
    for k,v in pairs(Shared.Vehicles) do 
        ...
        for i=1, #v do 
            ...
            if GetHashKey(model) == currentVehicle then 
                ESX.TriggerServerCallback('lrp-luchtvaartdealer:server:cb:quickSell', function(bool)
                    if bool then 
...
Exios.Functions.SpawnPeds = function()
    ...
    for i=1, #Shared.Locations do 
        ...
        exports.ox_target:addLocalEntity(Shared.Locations[i]['ped'], {
            {
                event = 'lrp-luchtvaartdealer:client:open:catalogus',
