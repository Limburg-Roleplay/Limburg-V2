...
ESX.RegisterServerCallback('lrp-boatdealer:isPlateTaken', function (source, cb, plate)
...
AddEventHandler('exios-boatshop:server:handler:requestscreenshot', function(vehName, cameraId, vehBrand, label)
    ...
    exports['screenshot-basic']:requestClientScreenshot(src, {
        fileName =  'resources/[lrp]/lrp-boatdealer/src/html/voertuigen/' .. vehBrand .. '_' .. vehName .. '_' .. cameraId .. '_' .. label .. '.png'
    }, function(err, data)
        print(data)
    end)
end)
