...
if Config.LetPlayersChangeVisibilityOfRadioList then
	...
	TriggerEvent("chat:addSuggestion", "/"..Config.RadioListVisibilityCommand, "Zet de radiolijst aan/uit")
end

if Config.LetPlayersSetTheirOwnNameInRadio then
	TriggerEvent("chat:addSuggestion", "/"..Config.RadioListChangeNameCommand, "Verander je naam in de radio lijst", { { name = 'Naam', help = "Typ de naam in die je wilt." } })
end
