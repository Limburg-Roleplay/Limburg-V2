...
ESX.RegisterServerCallback('lrp-garage:server:can:pay:impound', function(source, cb, plate)
    ...
    if xPlayer.getAccount('bank').money >= price then
        ...
        cb(false)
        TriggerClientEvent("lrp-notifications:client:notify", xPlayer.source, 'error', 'Je hebt niet genoeg geld om jouw voertuig uit de impound te halen..')
    end
end)
...
AddEventHandler('lrp-garage:server:garage:VehicleTransfer', function(data, playerId)
    ...
    if not tPlayer then TriggerClientEvent('lrp-notifications', xPlayer.source, 'error', 'Deze speler is niet in de stad..') return end
    ...
    -- TriggerClientEvent('lrp-notifications', xPlayer.source, 'success', 'Voertuig met kentekenplaat: ' .. data.props.plate .. ' is overgeschreven!')
