Notification = function(messagetype, description, ms)
    ...
    exports['okokNotify']:Alert(messagetype, description, ms, messagetype)
    -- SendNUIMessage({
...
RegisterNetEvent('lrp-notifications:client:notify')
AddEventHandler('lrp-notifications:client:notify', Notification)
