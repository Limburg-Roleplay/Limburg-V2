...
AddEventHandler('esx_lscustom:buyMod', function(price)
    ...
    if playerMoney >= price then
        ...
        TriggerClientEvent("lrp-notifications:client:notify", source, 'success', 'Je hebt €'..price..' betaald voor je tuning.<br>Sla het voertuig op in je Garage!')
    ...
    elseif bankMoney >= neededAmount then
        ...
        TriggerClientEvent("lrp-notifications:client:notify", source, 'error', 'Je hebt niet genoeg geld voor deze mod!')
