...
RegisterServerEvent('lrp-logger:schotenGelost')
AddEventHandler('lrp-logger:schotenGelost', function(weapon, count)
...
RegisterServerEvent('lrp-logger:createlog')
AddEventHandler('lrp-logger:createlog', function(webhook, title, message, tag, type)
