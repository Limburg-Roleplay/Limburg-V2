local xcustomcmd = ""
TriggerEvent("chat:addSuggestion", "/a", "Praat in staffchat.", {{name = "text", help = "text admin chat"}})
TriggerEvent(
    "chat:addSuggestion",
    "/reply",
    "Reageer op een report.",
    {{name = "player", help = "player id"}, {name = "replay", help = "replay text"}}
)
