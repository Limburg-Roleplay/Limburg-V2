...
function EmoteCommandStart(source, args, raw)
    if #args > 0 then
        ...
        elseif DP.PropEmotes[name] ~= nil then
            ...
            if args['cancelated'] then CanCancel = false end
...
function DestroyAllProps()
    ...
    for _, v in pairs(PlayerProps) do
        TriggerServerEvent('dpemotes:ptfx:destroyItem', NetworkGetNetworkIdFromEntity(v))
    end
...
exports("EmoteCommandStart", function(emoteName, textureVariation)
        EmoteCommandStart(nil, {emoteName, textureVariation, ['cancelated'] = true}, nil)
end)
exports("EmoteCancel", function() CanCancel = true EmoteCancel() end)
exports("isPlayingEmote", function() return cooldown ~= nil and true or false end)
