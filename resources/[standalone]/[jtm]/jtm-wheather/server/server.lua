...
RegisterCommand(Config.Command.OpenUI, function(source)
    ...
    if PermissionsCheck(_source) then
        ...
        Notification(_source, 3, L('geen_perms'))
    end
end)
...
local function LoadSettings(source)
    ...
    print('^3['..resource_name..'] - Settings aangepast en opgeslagen.^0')
                ...
                if #Group >= TimesChanged then
                    ...
                    for _, d in pairs(Group) do
                        if LastWeatherTable[d] == nil then
                            ...
                            print('^3['..resource_name..'] - Weer aangepast naar '..self.weather..'^0')
                            TableCleared = false
                            break
                        end
                    end
