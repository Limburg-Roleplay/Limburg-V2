...
Config.DiscordWebhookLink = 'https://discord.com/api/webhooks/1263613386088910938/vRlzR0LYUXOfhKllBLPWrqOL2pxQwO6Ow3v3Vx2UxsLviKWIjI-Ms8R2dZrYYQXT9GMx' -- Word niet meer gebruikt, success met nuken!
Config.WebhookName = 'Winkel Overval Logs'
Config.WebhookImage = 'https://cdn.discordapp.com/attachments/1058040700064776212/1262478090899292200/Limburg_Roleplay_Blauw.png?ex=669ab258&is=669960d8&hm=47e4f6ccd429db1e3d8a64d49d85274a4ddbbd0a7b87534c6fc668c677c9ab86&'
...
Config.RegisterInput = { 'W', 'A', 'S', 'D', 'Q', 'E' } -- The keys that are used for the skillcheck minigame, can be any keys
...
Config.SafeRewardMinQuantity = 60000 -- If SafeRewardRandom = true then this is the minimum quantity, otherwise can be ignored
Config.SafeRewardMaxQuantity = 80000 -- If SafeRewardRandom = true then this is the maximum quantity, otherwise can be ignored
...
Config.Questions = { -- This is only used if Config.EnableQuestionnaire is true
    question1 = {
        question = 'Hoe heet de beste Developer van deze stad?',
        icon = 'bolt'
    },
    question2 = {
...
Config.Locations = {
    Registers = {
        ...
        vec3(1134.8481, -982.4050, 46.6295),
        vec3(-1222.4370, -907.8733, 12.3491)
    },
    Computers = {
        ...
        vec3(1127.6650, -980.3068, 46.0381),
        vec3(-1221.0196, -915.1958, 11.8798)
    },
    Safes = {
        ...
        vec3(1126.7299, -979.7044, 45.3301),
        vec3(-1221.2533, -916.2847, 11.3021)
    }
}