...
local npcCoords1 = vector3(563.2271, 520.5809, 105.2589)
local npcHeading1 = 155.4780

local blipCoords = vector3(563.2271, 520.5809, 106.2589) 
...
AddEventHandler('exios-witwas:client:start:cleaning', function(data)
    ...
    if dist > 1.5 then exports['lrp-notifications']:notify('error', 'Deze actie is niet meer mogelijk, probeer het opnieuw') return end
...
Exios.Functions.StopWitwas = function()
    RemoveBlip(routeBlip)
    exports["lrp-notifications"]:Notify("error", "Je had niet genoeg Zwartgeld opzak! Of je hebt de missie handmatige gestopt!", 5000)
end
