...
RegisterNetEvent('jtm-development:client:handler:startFotobook')
AddEventHandler('jtm-development:client:handler:startFotobook', function(group)
        for vehicleId = 1, #Shared.Fotobook.Vehicles do
            ...
            if vehicleLoaded then
                ESX.Game.SpawnVehicle(vehName, Shared.Fotobook.CarSettings['coords'], Shared.Fotobook.CarSettings['heading'], function(veh) 
                    ...
                    SetVehicleNumberPlateText(veh, 'Limburg')
                    for cameraId = 1, #Shared.Fotobook.Cameras do
                        ...
                        for k,v in pairs(Shared.Fotobook.Colors) do
                            ...
                            TriggerServerEvent('jtm-development:server:handler:requestscreenshot', vehName, cameraId, vehBrand, k)
                            Wait(375)
                        end
